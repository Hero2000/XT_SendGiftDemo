...
@implementation XTManagerAnimation
...
-(void)setContentView:(UIView *)contentView {
    ...
    [contentView addSubview:self.presentView1];
    [contentView addSubview:self.presentView2];
    
    self.presentView1.frame = CGRectMake(-240, 300 * 0.3, 240, 60);
    self.presentView2.frame = CGRectMake(-240, 300 * 0.3 + 100, 240, 60);
}
